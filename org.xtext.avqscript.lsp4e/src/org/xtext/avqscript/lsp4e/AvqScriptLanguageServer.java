package org.xtext.avqscript.lsp4e;
...
public class AvqScriptLanguageServer implements StreamConnectionProvider {
	
	private final static boolean SOCKET_MODE = true;
	private StreamConnectionProvider delegate;

	public AvqScriptLanguageServer() {
		if (SOCKET_MODE) {
			...
			URL resource = bundle.getResource("/language-server/avqscript-language-server-jar");
			try {
	...
	public String toString() {
		return "AvqScript Language Server: " + super.toString();
	}
}
